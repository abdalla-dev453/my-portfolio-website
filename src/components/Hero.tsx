  ...
  return (
    <section id="home" className="relative overflow-hidden bg-ink pt-24">
      <div className="hero-grid mx-auto grid min-h-[650px] max-w-7xl items-center gap-10 px-6 pb-16 sm:px-8 lg:grid-cols-[1.05fr_.95fr] lg:px-12">
        <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.75, ease: 'easeOut' }} className="relative z-10 pt-12 lg:pt-0">
          <motion.p initial={{ opacity: 0, x: -12 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.25 }} className="inline-flex items-center gap-2 border border-forest/30 bg-paper px-3 py-2 text-xs font-medium text-forest shadow-sm"><span className="h-2 w-2 bg-sun" /> Hello there!</motion.p>
        ...
        <motion.div initial={{ opacity: 0, scale: 0.94, x: 18 }} animate={{ opacity: 1, scale: 1, x: 0 }} transition={{ duration: 0.85, delay: 0.12, ease: 'easeOut' }} className="mx-auto w-full max-w-[500px] self-end lg:mr-0">

...
const projects: Project[] = [
  {
    ...
    github: 'https://github.com/bhokemwita/Project-Showcase-App',
    demo: '#',
  },
  {
    ...
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRtnt2AjyTrE21JfEpgDVQ21Jo0roXD-XRkKqO3kcyV1g&s=10',
    github: '#',
    demo: '#',
  },
  {
    title: 'Samaki Soko App',
    description: 'A modern, responsive web application built with React and RESTful APIs.',
    problem: 'Small businesses lacked an affordable, customizable online selling platform.',
    solution: 'Built a scalable e-commerce platform with RESTful API backend and responsive React frontend.',
    tech: ['JavaScript', 'REST APIs', 'CSS', 'HTML'],
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRShY0UerEBtzInrwBFAAdMJdFKTEq24NrDRHnYLlqohg&s=10',
    github: 'https://github.com/abdalla-dev453/samaki-soko-app',
    demo: '#',
  },
  {
  ...
  {
    title: 'Afya Digital',
    description: 'A responsive landing page for a healthcare startup, showcasing features and testimonials.',
    problem: 'Needed a simple and visually appealing landing page for a healthcare startup.',
    solution: 'Designed and developed this landing page with a focus on user experience and accessibility.',
    tech: ['React', 'TailwindCSS', 'Framer Motion', 'Vite'],
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQXfAv5Oh5IXC4VNLaywi8nyK269W71CLvioJAieqpLw&s=10',
    github: '#',
    demo: '#',
  },
  {
    title: 'Pwani Booking App',
    description: 'A user-friendly booking app for travel enthusiasts, enabling seamless reservations and real-time updates.',
    problem: 'Travel enthusiasts needed a hassle-free booking platform with real-time updates.',
    solution: 'Designed and developed this booking app with a focus on user experience and accessibility.',
    tech: ['React', 'TailwindCSS', 'Framer Motion', 'Vite'],
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_7POkoPqHcUoAVdW9N8EuW4amI7dhGnZmDVc3NmpOR7V3ihFPKPvBtvg&s=10',
    github: 'https://github.com/abdalla-dev453/pwani-booking',
    demo: '#',
  }
];
